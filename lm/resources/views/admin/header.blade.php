            ...
            <div class="dropdown d-inline-block ml-2">
                ...
                <div class="dropdown-menu dropdown-menu-right p-0 border-0 font-size-sm" aria-labelledby="page-header-user-dropdown">
                    ...
                    <div class="p-2">
                        ...
                        <form method="post" id="form-logout" action="{{ url('/logout') }}" style="display: none;">{{ csrf_field() }}</form>
                        <a class="dropdown-item d-flex align-items-center justify-content-between" onclick="document.getElementById('form-logout').submit();" tabindex="-1" href="#">
                            <span>Log Out</span>
