<template>
  <div class="vdatetime-calendar">
    ...
    <div class="vdatetime-calendar__month">
      <div class="vdatetime-calendar__month__weekday" v-for="(weekday, n) in weekdays" :key="weekday + ' ' + n">{{ weekday }}</div>
      <div class="vdatetime-calendar__month__day" v-for="(day, n) in days" @click="selectDay(day)" :key="day + ' ' + n" :class="{'vdatetime-calendar__month__day--selected': day.selected, 'vdatetime-calendar__month__day--disabled': day.disabled}">
