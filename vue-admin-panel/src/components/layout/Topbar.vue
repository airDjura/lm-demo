    ...
    <div class="content-header">
      ...
      <div class="d-flex align-items-center">
        ...
        <!--<form class="d-none d-sm-inline-block" action="/dashboard" method="POST">-->
          ...
          <!--</div>-->
        <!--</form>-->
            <multiselect :allowEmpty="false" style="min-width: 300px;" class="d-none d-sm-inline-block" track-by="uuid" v-model="currentSeason" :options="seasonOptions" @select="selectSeason" @search-change="getOptions" :customLabel="customLabel"></multiselect>
        <!-- END Search Form -->
      </div>
      <!-- END Left Section -->
        ...
        <div class="dropdown d-inline-block ml-2">
          ...
          <div class="dropdown-menu dropdown-menu-right p-0 border-0 font-size-sm"
            ...
            <ul class="nav-items mb-0">
              <li v-for="lng in availableLanguages" :class="({'bg-info-light': language === lng})" :key="lng">
                <a class="text-dark media py-2" href="#" @click.prevent="language = lng">
                  <div class="mr-2 ml-3">
                    <i style="font-size: 16px" :class="'flag-icon flag-icon-' + lng"></i>
                  </div>
                  <div class="media-body pr-2">
                    <div class="font-w600">{{$t('language.' + lng)}}</div>
                  </div>
                </a>
              </li>
            </ul>
...
export default {
  ...
  methods: {
    ...
    selectSeason (o) {
      ...
      UserService.setCurrentSeason(data).then((response) => {
        this.currentSeason = response.data.currentSeason
        this.$store.commit('currentUser', response.data)
        this.$store.commit('currentSeason', response.data.currentSeason.uuid)
